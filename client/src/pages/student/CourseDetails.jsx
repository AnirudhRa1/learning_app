...
const CourseDetails = () => {
    ...
    const enrollCourse = async () => {
        try {
            ...
            const baseUrl = backendUrl || 'https://learning-app-backend-rust.vercel.app/';
            const apiUrl = baseUrl.endsWith('/') 
                ? `${baseUrl}api/user/purchase`
                : `${baseUrl}/api/user/purchase`;
                ...
                <div className="max-w-xl z-10 text-gray-500">
                    ...
                    <p className="text-sm">
                        ...
                        <span className="text-blue-600 underline">
                            {courseData.educator ? courseData.educator.name : 'Unknown Instructor'}
                        </span>
                    </p>
